...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull RelativeLayout rootView, @NonNull TextView emptyView,
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHistoryBinding((RelativeLayout) rootView, emptyView, recyclerView);
    }
